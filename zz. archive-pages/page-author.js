                  ...
                  <div className="author-bio mb-50 bg-white p-30 border-radius-10">
                    ...
                    <div className="author-info">
                      ...
                      <div className="author-description text-muted">
                        ...
                        page. Graduating from a top accelerator or incubator can
                        be as career-defining for a startup founder as an elite
                        university diploma.
                      </div>
                          ...
                          <div className="post-content p-30">
                            ...
                            <div className="d-flex post-card-content">
                              ...
                              <div className="post-excerpt mb-25 font-small text-muted">
                                <p>
                                  Graduating from a top accelerator or incubator
                                  can be as career-defining for a&nbsp;startup
                                  founder&nbsp;as an elite university diploma.
                                  The intensive programmes, which…
                                </p>
                              </div>
                        ...
                        <div className="post-card-1 border-radius-10 hover-up">
                          ...
                          <div className="post-content p-30">
                            ...
                            <div className="d-flex post-card-content">
                              <h5 className="post-title mb-20 font-weight-900">
                                <Link href="/single">
                                  <a>Tips for Growing Healthy, Longer Hair</a>
                                </Link>
                              </h5>
                              <div className="post-excerpt mb-25 font-small text-muted">
                                <p>
                                  Proin vitae placerat quam. Ut sodales eleifend
                                  urna, in condimentum tortor ultricies eu. Nunc
                                  auctor iaculis dolorProin vitae placerat quam.
